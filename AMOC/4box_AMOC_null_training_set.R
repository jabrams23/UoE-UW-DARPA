...
# this code creates 10000 time series where the bifurcation parameter (freshwater flux) is fixed
...
M_n_null <- array(NA, dim=c(5501,10000))
Fn_w1_null <- rep(NA, 10000)
Fn_w2_null <- rep(NA, 10000)
K_v_null <- rep(NA, 10000)
M_ek_null <- rep(NA, 10000)
A_GM_null <- rep(NA, 10000)
e_null <- rep(NA, 10000)
Aredi_null <- rep(NA, 10000)
fsig_null <- rep(NA, 10000)
